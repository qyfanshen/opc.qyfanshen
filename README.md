# OPC Ecosystem Community

> Landing & Recruitment Hub for One-Person Company Ecosystem

> 🚀 **[Live Demo](https://opc.qyfanshen.com)** · 📚 **[Docs](docs/)** · 📋 **[Quick Start](docs/QUICKSTART.md)** · 🐛 **[Report Bug](https://github.com/qyfanshen/opc.qyfanshen/issues)** · ⭐ **[Star](https://github.com/qyfanshen/opc.qyfanshen)**

![preview](screenshots/preview.png)
<p align="center">
  <a href="https://github.com/qyfanshen/opc.qyfanshen"><img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="License"></a>
...
- **🚀 Solo-founder onboarding** — Join the one-person-company ecosystem and access shared resources.
- **🤝 Community & events** — Discover collaboration opportunities and community activities.
- **📋 Recruitment funnel** — Submit application and track onboarding steps.

## Features

### Core Features
- Recruitment landing page for One-Person Company ecosystem members
- Backend submission API: `/api/submit.php` for application forms
- Bootstrap-based architecture: `config/app.php` + `inc/bootstrap.php`
- Admin module for reviewing applications and managing community members
- Privacy-first: HTTPS, security headers, sensitive-file isolation
- Easy deployment on shared hosting with .htaccess + nginx config samples

### Technical Features
- Modern web stack: PHP 8+ · MySQL · Nginx
...
![About section](screenshots/flow-about.png)
...
```bash
git clone https://gitee.com/qyfanshen/opc.qyfanshen.git
cd opc.qyfanshen.com
...
server {
    ...
    ssl_certificate     /etc/nginx/ssl/opc-community.crt;
    ssl_certificate_key /etc/nginx/ssl/opc-community.key;

    root /var/www/opc.qyfanshen.com;
...
- [ ] HTTPS 已生效（浏览器锁图标）
- [ ] `https://opc.qyfanshen.com/.env` 返回 404
...
- Domain: https://opc.qyfanshen.com
